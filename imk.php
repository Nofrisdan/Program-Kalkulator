...
<body>
    <div class="cover">
        <div style="border:5px solid  #000080 ; width:350px; margin:20px; padding:20px; background-color:white;">
            ...
            <form action="" method="post">
                <ul >
                    <li><input type="text" autocomplete="off" placeholder="Masukkan Bilangan Pertama" name="bil1" required autofocus></li>
                    <li><input type="text" autocomplete="off" placeholder="Masukkan Bilangan kedua" name="bil2" required></li>
                    <li>
            ...
            <marquee scrollamount="3">
                <h2 style="font-size:15px; margin-top:10px; margin-left:50px;">Copyright&copy;2020 Nofrisdan Sitopu</h2>
            </marquee>
         </div>
    </div>
